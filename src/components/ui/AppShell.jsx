          ...
          <div className="relative w-full px-4 sm:px-6 py-3 sm:py-4">
            ...
            <div className="max-w-6xl mx-auto flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
              <div className="space-y-1">
                <span className="inline-flex items-center gap-2 rounded-full border border-emerald-500/15 bg-emerald-500/6 px-3 py-1 text-[10px] font-medium uppercase tracking-[0.22em] text-emerald-300/90">
                  Workspace
                </span>
